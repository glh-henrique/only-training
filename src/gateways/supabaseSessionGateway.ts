...
export const supabaseSessionGateway = {
  ...
  setSessionFinished: async (userId: string, sessionId: string, endedAt: string, duration: number, rpe: number | null = null, avgHeartRate: number | null = null, caloriesKcal: number | null = null): Promise<void> => {
