  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-50 h-[76px] border-t border-[#ececf0] flex items-start justify-around px-5 pt-2.5"
      ...
      <Link to="/" className="flex flex-col items-center gap-1">
        ...
        <span className="font-ot-mono text-[8.5px] tracking-[0.04em]" style={{ color: color('/') }}>{t('nav.home').toUpperCase()}</span>
      </Link>
      ...
      <Link to="/workouts" className="flex flex-col items-center gap-1">
        ...
        <span className="font-ot-mono text-[8.5px] tracking-[0.04em]" style={{ color: color('/workouts') }}>{t('nav.workouts').toUpperCase()}</span>
      </Link>
      ...
      <Link to="/history" className="flex flex-col items-center gap-1">
        ...
        <span className="font-ot-mono text-[8.5px] tracking-[0.04em]" style={{ color: color('/history') }}>{t('nav.history').toUpperCase()}</span>
      </Link>
      ...
      <Link to="/profile" className="flex flex-col items-center gap-1">
        ...
        <span className="font-ot-mono text-[8.5px] tracking-[0.04em]" style={{ color: color('/profile') }}>{t('nav.profile').toUpperCase()}</span>
      </Link>
    </nav>
  )
}
